...
public class EncryptUtils {
     ...
     * @return byte[]
     */
    public static byte[] DESEncrypt(final String key, final String content) throws Exception {
     ...
     * @return byte[]
     */
    public static byte[] DESDecrypt(final String key, final byte[] encoderContent) throws Exception {
    ...
    private static byte[] processCipher(final byte[] processData, final Key key,
                                        final int opsMode, final String algorithm) throws Exception {
     ...
     * @return byte[]
     */
    public static byte[] getSignature(final byte[] encoderContent) throws Exception {
     ...
     * @return byte[]
     */
    public static boolean verifySignature(final byte[] encoderContent, final byte[] signContent) throws Exception {
     ...
     * @return byte[]
     */
    public static byte[] RSAEncrypt(final String content) throws Exception {
     ...
     * @return byte[]
     */
    public static byte[] RSADecrypt(final byte[] encoderContent) throws Exception {
     ...
     * @return String
     */
    public static byte[] HMACEncrypt(final String key, final String content) throws Exception {
