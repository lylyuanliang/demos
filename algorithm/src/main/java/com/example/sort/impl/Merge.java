...
public class Merge implements Sort {
     ...
     * 合并, 详细过程说明如下                                                     <br>
     * 待排序数组为:                                                             <br>
     * [12, 1000, 333, 11, 2, 3, 1, 0, 9, 8, 11, 44, 56]                     <br>
     * 排序过程                                                                      <br>
     * 第1轮数组下标范围:0~1                                                              <br>
     * 第1轮分割的子数组: [12]  [1000]                                                       <br>
     * 第1轮归并到原数组:[12, 1000, 333, 11, 2, 3, 1, 0, 9, 8, 11, 44, 56]                     <br>
     * 第2轮数组下标范围:2~3                                                                <br>
     * 第2轮分割的子数组: [333]  [11]                                                          <br>
     * 第2轮归并到原数组:[12, 1000, 11, 333, 2, 3, 1, 0, 9, 8, 11, 44, 56]                     <br>
     * 第3轮数组下标范围:0~3                                                                 <br>
     * 第3轮分割的子数组: [12, 1000]  [11, 333]                                              <br>
     * 第3轮归并到原数组:[11, 12, 333, 1000, 2, 3, 1, 0, 9, 8, 11, 44, 56]                     <br>
     * 第4轮数组下标范围:4~5                                                                   <br>
     * 第4轮分割的子数组: [2]  [3]                                                      <br>
     * 第4轮归并到原数组:[11, 12, 333, 1000, 2, 3, 1, 0, 9, 8, 11, 44, 56]                     <br>
     * 第5轮数组下标范围:4~6                                                               <br>
     * 第5轮分割的子数组: [2, 3]  [1]                                             <br>
     * 第5轮归并到原数组:[11, 12, 333, 1000, 1, 2, 3, 0, 9, 8, 11, 44, 56]                     <br>
     * 第6轮数组下标范围:0~6                                                  <br>
     * 第6轮分割的子数组: [11, 12, 333, 1000]  [1, 2, 3]                                     <br>
     * 第6轮归并到原数组:[1, 2, 3, 11, 12, 333, 1000, 0, 9, 8, 11, 44, 56]                     <br>
     * 第7轮数组下标范围:7~8                                                                <br>
     * 第7轮分割的子数组: [0]  [9]                                                         <br>
     * 第7轮归并到原数组:[1, 2, 3, 11, 12, 333, 1000, 0, 9, 8, 11, 44, 56]                     <br>
     * 第8轮数组下标范围:7~9                                                                  <br>
     * 第8轮分割的子数组: [0, 9]  [8]                                                  <br>
     * 第8轮归并到原数组:[1, 2, 3, 11, 12, 333, 1000, 0, 8, 9, 11, 44, 56]                     <br>
     * 第9轮数组下标范围:10~11                                                           <br>
     * 第9轮分割的子数组: [11]  [44]                                                           <br>
     * 第9轮归并到原数组:[1, 2, 3, 11, 12, 333, 1000, 0, 8, 9, 11, 44, 56]                     <br>
     * 第10轮数组下标范围:10~12                                                      <br>
     * 第10轮分割的子数组: [11, 44]  [56]                                          <br>
     * 第10轮归并到原数组:[1, 2, 3, 11, 12, 333, 1000, 0, 8, 9, 11, 44, 56]                     <br>
     * 第11轮数组下标范围:7~12                                                            <br>
     * 第11轮分割的子数组: [0, 8, 9]  [11, 44, 56]                                    <br>
     * 第11轮归并到原数组:[1, 2, 3, 11, 12, 333, 1000, 0, 8, 9, 11, 44, 56]                     <br>
     * 第12轮数组下标范围:0~12                                                                      <br>
     * 第12轮分割的子数组: [1, 2, 3, 11, 12, 333, 1000]  [0, 8, 9, 11, 44, 56]                     <br>
     * 第12轮归并到原数组:[0, 1, 2, 3, 8, 9, 11, 11, 12, 44, 56, 333, 1000]                     <br>
     *
     * @param array 原数组
